...
type TopLeft<T extends string> = T extends `${infer _ extends Symbol}${
  | "."
  | Symbol}${"." | Symbol}
${"." | Symbol}${infer val extends number}${"." | Symbol}
${"." | Symbol}${"." | Symbol}${"." | Symbol}`
  ? val
  : TopCenter<T>;

type TopCenter<T extends string> = T extends `.${infer _ extends Symbol}${
  | "."
  | Symbol}
${"." | Symbol}${infer val extends number}${"." | Symbol}
${"." | Symbol}${"." | Symbol}${"." | Symbol}`
...
type TopRight<T extends string> = T extends `..${infer _ extends "." | Symbol}
${"." | Symbol}${infer val extends number}${"." | Symbol}
${"." | Symbol}${"." | Symbol}${"." | Symbol}`
  ? val
  : Left<T>;

type Left<T extends string> = T extends `...
${infer _ extends "." | Symbol}${infer val extends number}${"." | Symbol}
${"." | Symbol}${"." | Symbol}${"." | Symbol}`
  ? val
  : Right<T>;

type Right<T extends string> = T extends `...
.${infer val extends number}${infer _ extends "." | Symbol}
${"." | Symbol}${"." | Symbol}${"." | Symbol}`
  ? val
  : BottomLeft<T>;

type BottomLeft<T extends string> = T extends `..${"." | Symbol}
.${infer val extends number}.
${infer _ extends "." | Symbol}${"." | Symbol}${"." | Symbol}`
  ? val
  : BottomCenter<T>;

type BottomCenter<T extends string> = T extends `...
.${infer val extends number}.
.${infer _ extends "." | Symbol}${"." | Symbol}`
  ? val
  : BottomRight<T>;

type BottomRight<T extends string> = T extends `...
.${infer val extends number}.
..${infer _ extends Symbol}`
  ? val
  : false;

type Next<T extends string> = T extends `${infer _}${infer Rest}`
  ? TopLeft<Rest>
  : 0;

type GetMyNum = TopLeft<`...
.256.
...`>;
